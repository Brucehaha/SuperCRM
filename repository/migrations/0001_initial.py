# Generated by Django 2.1.5 on 2019-03-26 05:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[('0', 'VIC'), (1, 'NSW'), (2, 'QLD'), (3, 'SA'), (3, 'WA'), (4, 'TAS')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductToImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Images')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Product')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='images',
            name='product',
            field=models.ManyToManyField(to='repository.Product'),
        ),
        migrations.AddField(
            model_name='discount',
            name='interval',
